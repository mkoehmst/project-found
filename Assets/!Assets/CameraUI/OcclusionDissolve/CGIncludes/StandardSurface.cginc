...
void vert (inout appdata_vert v, out InputFT o) {
...
void surf (InputSS IN, inout SurfaceOutputStandard o) {
#ifdef _PARALLAXMAP
...
void final (InputFT IN, SurfaceOutputStandard o, inout fixed4 color)
{
